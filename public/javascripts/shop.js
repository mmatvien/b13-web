...
$(function () {
    ...
    var THE_BODY = $('body'),
        ...
        IS_PRODUCT = (CONTAINER.hasClass('template-product')) ? true : false,
    ...
    if (char_count <= 5) {
        char_elem.css('opacity', 1);
    }
    if (char_count >= 6) {
        char_elem.css('font-size', '18px').css('opacity', 1)
    }
    if (char_count >= 7) {
        char_elem.css('font-size', '15px').css('opacity', 1)
    }
    if (char_count >= 8) {
        char_elem.css('font-size', '13px').css('opacity', 1)
    }
    if (char_count >= 9) {
        char_elem.css('font-size', '11px').css('opacity', 1)
    }
